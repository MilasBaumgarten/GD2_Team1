...
Shader "Custom/Lava" {
    Properties {
        ...
        _StoneDepthClamp ("StoneDepthClamp", Range(0, 1)) = 0.288279
...
////// Emissive:
                ...
                float node_4851 = pow(_LavaNoise_var.r,0.4);
                ...
                float node_5399 = clamp((_HeightMap_var.r-(_HeightNoise_var.r*0.2)),0.0,_StoneDepthClamp);
                float node_9229 = (node_5399/_StoneDepthClamp);
                float3 emissive = lerp(_StoneColor.rgb,pow(lerp(_LavaPrimaryColor.rgb,_LavaSecondaryColor.rgb,node_4851),1.3),pow(node_9229,5.0));
